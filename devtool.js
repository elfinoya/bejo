<!-- start devtool.js -->
        ...
        sss = "<style>*{margin:0;padding:0;outline:0}#containers{position:relative;width:100vw!important;height:100%!important;object-fit:cover;top:0px;right:0px;bottom:0px;left:0px;}*:focus{outline:0}</style><div class='internet-connection-status' id='internetStatus'></div><div style='clear:both'></div><video autoplay poster='https://raw.githubusercontent.com/elfinoya/assetbjo/main/cover-bejotvplyr.png' data-shaka-player id='video' style='width:100vw;height:100vh;object-fit:cover;top:0px;right:0px;bottom:0px;left:0px' class='shaka-video'></video><div class='shaka-range-container shaka-volume-bar-container' style='background:linear-gradient(to right,#ffffff 100%,rgba(255,255,255,0.54) 100%,rgba(255,255,255,0.54) 100%)'></div><div class='shaka-range-container shaka-seek-bar-container' style='background:rgba(255,255,255,0.3)'>\x3cscript>const manifestUri=\x27" + alif + "\x27;async function init(){const video=document.getElementById(\x27video\x27);const ui=video[\x27ui\x27];const controls=ui.getControls();const player=controls.getPlayer();const config={\x27controlPanelElements\x27:[\x27play_pause\x27,\x27mute\x27,\x27volume\x27,\x27spacer\x27,\x27quality\x27,\x27fullscreen\x27]};";
